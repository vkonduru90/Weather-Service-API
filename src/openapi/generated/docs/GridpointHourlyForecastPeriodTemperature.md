# GridpointHourlyForecastPeriodTemperature
...
```typescript
import { GridpointHourlyForecastPeriodTemperature } from './api';

const instance: GridpointHourlyForecastPeriodTemperature = {
    value,
    maxValue,
    minValue,
    unitCode,
