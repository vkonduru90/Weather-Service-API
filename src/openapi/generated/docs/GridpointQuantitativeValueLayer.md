...
**values** | [**Array&lt;GridpointQuantitativeValueLayerValuesInner&gt;**](GridpointQuantitativeValueLayerValuesInner.md) |  | [default to undefined]

## Example

```typescript
import { GridpointQuantitativeValueLayer } from './api';

const instance: GridpointQuantitativeValueLayer = {
    uom,
    values,
};
```
